...
class BipartiteGraphDataLoaderWiki:
    def __init__(self, group_u_list_file_path, group_u_attr_file_path, group_u_label_file_path,
                 edge_list_file_path,
                 group_v_list_file_path, group_v_attr_file_path, group_v_label_file_path, device='cpu'):
        self.device = device
